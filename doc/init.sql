...
CREATE TABLE `file_info` (
  ...
  `study_info_id` varchar(128) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `study_check_pos`
-- ----------------------------
...
CREATE TABLE `study_check_pos` (
  ...
  KEY `FK4nnxthj71rugqpkt12wv0h8vj` (`studyinfo_id`),
  CONSTRAINT `FK4nnxthj71rugqpkt12wv0h8vj` FOREIGN KEY (`studyinfo_id`) REFERENCES `study_info` (`studyinfo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of study_check_pos
-- ----------------------------
...
CREATE TABLE `study_info` (
  `studyinfo_id` varchar(128) NOT NULL,
  ...
  `status` varchar(4) DEFAULT NULL,
  `study_desc` varchar(512) DEFAULT NULL,
  `update_time` datetime DEFAULT NULL,
  `pat_id` varchar(64) DEFAULT NULL,
  `rpt_id` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`studyinfo_id`),
  KEY `FK3bb6pyognq8aec3d3o82qx05h` (`pat_id`),
  KEY `FKajk9b6avd74hnxtwnacl950ol` (`rpt_id`),
  CONSTRAINT `FK3bb6pyognq8aec3d3o82qx05h` FOREIGN KEY (`pat_id`) REFERENCES `patient` (`pat_id`),
  CONSTRAINT `FKajk9b6avd74hnxtwnacl950ol` FOREIGN KEY (`rpt_id`) REFERENCES `report` (`rpt_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
